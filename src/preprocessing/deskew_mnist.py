...
data = genfromtxt('C:\CMU\CMU-Spring-2016\DAP\working-directory\dap\data\mnist1.csv', delimiter=',')
print type(data)
...
np.savetxt(fname='mnist1-deskewed.csv', X=deskewed, delimiter=',', fmt='%6.6f')
...
#    
#    name = 'Deskewed-mnist1\image' + str(i) + '.png'
#    plt.savefig(name)
