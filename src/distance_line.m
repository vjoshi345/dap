function dist = distance_line(U, P)
%distance_line - Given matrices U and P, this function gives the distance 
%from points in P to the closest line segment induced by pairs of points
%in U.  
